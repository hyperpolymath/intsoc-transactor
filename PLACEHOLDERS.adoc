...
|===
|Placeholder |Description |Example |Files
|`+Intsoc Transactor+` |Human-readable project name |`+My Project+`
...
|`+INTSOC_TRANSACTOR+` |Uppercase identifier (for Idris2 modules, C
...
|`+intsoc-transactor+` |Repository name (slug) |`+my-project+`
...
|`+2026-08-05+` |Last updated date |`+2026-02-14+` |TOPOLOGY.md,
THREAT-MODEL.md
|===
