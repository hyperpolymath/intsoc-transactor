...
#
# Nix flake for intsoc-transactor
#
...
#
# TODO: Replace intsoc-transactor and {{PROJECT_DESCRIPTION}} with actual values.

{
  description = "intsoc-transactor — RSR-compliant project";
    ...
    flake-utils.lib.eachSystem [ "x86_64-linux" "aarch64-linux" ] (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            if [ -z "''${DIRENV_IN_ENVRC:-}" ] && [ -f .envrc ]; then
              ...
              export PROJECT_NAME="intsoc-transactor"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            echo "TODO: Add build commands for intsoc-transactor"
          '';
          ...
          meta = with pkgs.lib; {
            ...
            homepage = "https://github.com/hyperpolymath/intsoc-transactor";
