...
// Replace intsoc-transactor, Intsoc Transactor — See README.adoc for details., just run, Intsoc Transactor started successfully. with actuals
= intsoc-transactor — Quick Start for Users
:toc:
:toclevels: 2

== What is intsoc-transactor?

Intsoc Transactor — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./intsoc-transactor-portable
----
...
[source]
----
Intsoc Transactor started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/intsoc-transactor/wiki
