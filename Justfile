...
build-watch:
    ...
    find crates -name '*.rs' | entr -c just build
...
install: build-release
    ...
    cp target/release/intsoc ~/.local/bin/ 2>/dev/null || cp target/release/intsoc ~/.asdf/installs/rust/nightly/bin/
...
doctor:
    @echo "Running diagnostics for intsoc-transactor..."
...
heal:
    @echo "Attempting auto-repair for intsoc-transactor..."
...
help-me:
    @echo "=== intsoc-transactor Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/intsoc-transactor/issues/new"
    @echo ""
